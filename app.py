...
@st.cache_resource
def load_model():
    model  = joblib.load("C:/Users/amand/OneDrive/Desktop/house_hold_pred/best_model.pkl")
    scaler = joblib.load("C:/Users/amand/OneDrive/Desktop/house_hold_pred/scaler (2).pkl")
    return model, scaler
